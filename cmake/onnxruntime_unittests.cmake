...
## timings
add_executable(onnxruntime_mlas_timing ${TEST_SRC_DIR}/mlas/timing.cpp)
target_include_directories(onnxruntime_mlas_timing PRIVATE ${ONNXRUNTIME_ROOT}/core/mlas/inc)
set(onnxruntime_mlas_timing_libs onnxruntime_mlas onnxruntime_common)
if(onnxruntime_USE_NSYNC)
  list(APPEND onnxruntime_mlas_timing_libs nsync_cpp)
endif()
list(APPEND onnxruntime_mlas_timing_libs Threads::Threads)
target_link_libraries(onnxruntime_mlas_timing PRIVATE ${onnxruntime_mlas_timing_libs})
set_target_properties(onnxruntime_mlas_timing PROPERTIES FOLDER "ONNXRuntimeTiming")
